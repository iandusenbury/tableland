    ...
    <div className="about-inner-div">
      ...
      <Paper className="about-paper">
        ...
        <p className="about-text">
          ...
          they were involved in at these institutions. The user&lsquo;s career
          is then laid out on a Google Maps interface. The app is designed for
          students interested in STEM to see just how professionals in the field
          got to where they are and to see all the different routes that lead to
          success.
        </p>
      </Paper>
      <Paper className="about-paper">
